...
type Resolver interface {
	Resolve(ctx context.Context, req devconnect.ResolveRequest) (*devconnect.ResolveResponse, error)
}

// httpResolver calls the control plane's dev-connect resolve endpoint.
...
func (h *httpResolver) Resolve(ctx context.Context, req devconnect.ResolveRequest) (*devconnect.ResolveResponse, error) {
	...
	var out devconnect.ResolveResponse
