...
func (h *LegacyMCPHandler) ListProjects(ctx context.Context, namespaceName string) (any, error) {
...
func (h *LegacyMCPHandler) GetProject(ctx context.Context, namespaceName, projectName string) (any, error) {
	return h.Services.ProjectService.GetProject(ctx, namespaceName, projectName)
}

func (h *LegacyMCPHandler) CreateProject(ctx context.Context, namespaceName string, req *models.CreateProjectRequest) (any, error) {
