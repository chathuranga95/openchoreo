...
func (h *LegacyMCPHandler) ListClusterComponentTypes(ctx context.Context) (any, error) {
...
func (h *LegacyMCPHandler) GetClusterComponentType(ctx context.Context, cctName string) (any, error) {
...
func (h *LegacyMCPHandler) GetClusterComponentTypeSchema(ctx context.Context, cctName string) (any, error) {
