...
func (h *LegacyMCPHandler) ListComponentTypes(ctx context.Context, namespaceName string) (any, error) {
...
func (h *LegacyMCPHandler) GetComponentTypeSchema(ctx context.Context, namespaceName, ctName string) (any, error) {
	return h.Services.ComponentTypeService.GetComponentTypeSchema(ctx, namespaceName, ctName)
}

func (h *LegacyMCPHandler) ListWorkflows(ctx context.Context, namespaceName string) (any, error) {
...
func (h *LegacyMCPHandler) GetWorkflowSchema(ctx context.Context, namespaceName, workflowName string) (any, error) {
	return h.Services.WorkflowService.GetWorkflowSchema(ctx, namespaceName, workflowName)
}

func (h *LegacyMCPHandler) ListTraits(ctx context.Context, namespaceName string) (any, error) {
...
func (h *LegacyMCPHandler) GetTraitSchema(ctx context.Context, namespaceName, traitName string) (any, error) {
	return h.Services.TraitService.GetTraitSchema(ctx, namespaceName, traitName)
}

func (h *LegacyMCPHandler) ListObservabilityPlanes(ctx context.Context, namespaceName string) (any, error) {
