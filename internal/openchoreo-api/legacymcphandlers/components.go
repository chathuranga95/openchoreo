...
func (h *LegacyMCPHandler) CreateComponent(ctx context.Context, namespaceName, projectName string, req *models.CreateComponentRequest) (any, error) {
	return h.Services.ComponentService.CreateComponent(ctx, namespaceName, projectName, req)
}

func (h *LegacyMCPHandler) ListComponents(ctx context.Context, namespaceName, projectName string) (any, error) {
...
func (h *LegacyMCPHandler) GetComponent(ctx context.Context, namespaceName, projectName, componentName string, additionalResources []string) (any, error) {
	return h.Services.ComponentService.GetComponent(ctx, namespaceName, projectName, componentName, additionalResources)
}

func (h *LegacyMCPHandler) UpdateComponentBinding(ctx context.Context, namespaceName, projectName, componentName, bindingName string, req *models.UpdateBindingRequest) (any, error) {
	return h.Services.ComponentService.UpdateComponentBinding(ctx, namespaceName, projectName, componentName, bindingName, req)
}

func (h *LegacyMCPHandler) GetComponentObserverURL(ctx context.Context, namespaceName, projectName, componentName, environmentName string) (any, error) {
	return h.Services.ComponentService.GetComponentObserverURL(ctx, namespaceName, projectName, componentName, environmentName)
}

func (h *LegacyMCPHandler) GetBuildObserverURL(ctx context.Context, namespaceName, projectName, componentName string) (any, error) {
	return h.Services.ComponentService.GetBuildObserverURL(ctx, namespaceName, projectName, componentName)
}

func (h *LegacyMCPHandler) GetComponentWorkloads(ctx context.Context, namespaceName, projectName, componentName string) (any, error) {
	return h.Services.ComponentService.GetComponentWorkloads(ctx, namespaceName, projectName, componentName)
}

func (h *LegacyMCPHandler) ListComponentReleases(ctx context.Context, namespaceName, projectName, componentName string) (any, error) {
...
func (h *LegacyMCPHandler) CreateComponentRelease(ctx context.Context, namespaceName, projectName, componentName, releaseName string) (any, error) {
	return h.Services.ComponentService.CreateComponentRelease(ctx, namespaceName, projectName, componentName, releaseName)
}

func (h *LegacyMCPHandler) GetComponentRelease(ctx context.Context, namespaceName, projectName, componentName, releaseName string) (any, error) {
	return h.Services.ComponentService.GetComponentRelease(ctx, namespaceName, projectName, componentName, releaseName)
}

func (h *LegacyMCPHandler) ListReleaseBindings(ctx context.Context, namespaceName, projectName, componentName string, environments []string) (any, error) {
...
func (h *LegacyMCPHandler) PatchReleaseBinding(ctx context.Context, namespaceName, projectName, componentName, bindingName string, req *models.PatchReleaseBindingRequest) (any, error) {
	return h.Services.ComponentService.PatchReleaseBinding(ctx, namespaceName, projectName, componentName, bindingName, req)
}

func (h *LegacyMCPHandler) DeployRelease(ctx context.Context, namespaceName, projectName, componentName string, req *models.DeployReleaseRequest) (any, error) {
	return h.Services.ComponentService.DeployRelease(ctx, namespaceName, projectName, componentName, req)
}

func (h *LegacyMCPHandler) PromoteComponent(ctx context.Context, namespaceName, projectName, componentName string, req *models.PromoteComponentRequest) (any, error) {
...
func (h *LegacyMCPHandler) CreateWorkload(ctx context.Context, namespaceName, projectName, componentName string, workloadSpec interface{}) (any, error) {
...
func (h *LegacyMCPHandler) GetComponentSchema(ctx context.Context, namespaceName, projectName, componentName string) (any, error) {
	return h.Services.ComponentService.GetComponentSchema(ctx, namespaceName, projectName, componentName)
}

func (h *LegacyMCPHandler) GetComponentReleaseSchema(ctx context.Context, namespaceName, projectName, componentName, releaseName string) (any, error) {
	return h.Services.ComponentService.GetComponentReleaseSchema(ctx, namespaceName, projectName, componentName, releaseName)
}

func (h *LegacyMCPHandler) ListComponentTraits(ctx context.Context, namespaceName, projectName, componentName string) (any, error) {
...
func (h *LegacyMCPHandler) UpdateComponentTraits(ctx context.Context, namespaceName, projectName, componentName string, req *models.UpdateComponentTraitsRequest) (any, error) {
	return h.Services.ComponentService.UpdateComponentTraits(ctx, namespaceName, projectName, componentName, req)
}

func (h *LegacyMCPHandler) GetEnvironmentRelease(ctx context.Context, namespaceName, projectName, componentName, environmentName string) (any, error) {
	return h.Services.ComponentService.GetEnvironmentRelease(ctx, namespaceName, projectName, componentName, environmentName)
}

func (h *LegacyMCPHandler) PatchComponent(ctx context.Context, namespaceName, projectName, componentName string, req *models.PatchComponentRequest) (any, error) {
	return h.Services.ComponentService.PatchComponent(ctx, namespaceName, projectName, componentName, req)
}

func (h *LegacyMCPHandler) ListComponentWorkflows(ctx context.Context, namespaceName string) (any, error) {
...
func (h *LegacyMCPHandler) GetComponentWorkflowSchema(ctx context.Context, namespaceName, cwName string) (any, error) {
	return h.Services.ComponentWorkflowService.GetComponentWorkflowSchema(ctx, namespaceName, cwName)
}

func (h *LegacyMCPHandler) TriggerComponentWorkflow(ctx context.Context, namespaceName, projectName, componentName, commit string) (any, error) {
	return h.Services.ComponentWorkflowService.TriggerWorkflow(ctx, namespaceName, projectName, componentName, commit)
}

func (h *LegacyMCPHandler) ListComponentWorkflowRuns(ctx context.Context, namespaceName, projectName, componentName string) (any, error) {
...
func (h *LegacyMCPHandler) UpdateComponentWorkflowSchema(ctx context.Context, namespaceName, projectName, componentName string, req *models.UpdateComponentWorkflowRequest) (any, error) {
