...
func (h *LegacyMCPHandler) ListDataPlanes(ctx context.Context, namespaceName string) (any, error) {
...
func (h *LegacyMCPHandler) GetDataPlane(ctx context.Context, namespaceName, dpName string) (any, error) {
	return h.Services.DataPlaneService.GetDataPlane(ctx, namespaceName, dpName)
}

func (h *LegacyMCPHandler) CreateDataPlane(ctx context.Context, namespaceName string, req *models.CreateDataPlaneRequest) (any, error) {
